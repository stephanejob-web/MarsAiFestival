                        ...
                        >
                            ...
                            <div
                                className={`w-5 h-5 rounded border-2 shrink-0 flex items-center justify-center transition-all ${
                                    formData[name] ? "border-aurora bg-aurora" : "border-white/25"
                                }`}
                            >
                                {formData[name] && (
                                    <svg
                                        className="w-3 h-3 text-deep-sky"
                                        viewBox="0 0 12 10"
                                        fill="none"
                                    >
                                        <path
                            ...
                            <span className="text-sm font-semibold text-white-soft">
                                {label}
                                {required && (
                                    <span className="text-coral text-[0.65rem] ml-1.5">
                                        {t("form.required")}
                                    </span>
                                )}
                            </span>
