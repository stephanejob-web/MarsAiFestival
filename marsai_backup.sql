-- ================================================================
-- marsai_backup.sql — MarsAI Festival 2026
-- Sauvegarde complète de la base de données
-- ================================================================
-- INSTRUCTIONS phpMyAdmin (copier-coller) :
--   1. Dans phpMyAdmin, cliquez sur l'onglet "SQL"
--      (sans sélectionner de base de données avant)
--   2. Collez tout ce script dans la zone de texte
--   3. Cliquez sur "Exécuter"
--
-- Contenu :
--   - Création de la base `marsai` si elle n'existe pas
--   - 18 tables avec structure complète
--   - Toutes les données : 60 réalisateurs, 60 films,
--     6 jurys, 19 assignations, 11 commentaires jury,
...
CREATE TABLE `film` (
  ...
  `statut` enum('to_review','valide','arevoir','refuse','in_discussion','asked_to_modify') NOT NULL DEFAULT 'to_review',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
INSERT INTO `film_discussion` (`id`, `film_id`, `added_by`, `added_at`) VALUES (2,19,2,'2026-03-15 13:23:42'),(3,20,2,'2026-03-15 13:31:46');
...
INSERT INTO `jury_film_assignment` (`id`, `jury_id`, `film_id`, `assigned_by`, `assigned_at`) VALUES (1,2,1,1,'2026-03-15 11:43:37'),(2,2,2,1,'2026-03-15 11:43:37'),(3,2,3,1,'2026-03-15 11:43:37'),(4,2,4,1,'2026-03-15 11:43:37'),(5,2,5,1,'2026-03-15 11:43:37'),(6,2,6,1,'2026-03-15 11:43:37'),(7,2,7,1,'2026-03-15 11:43:37'),(8,2,8,1,'2026-03-15 11:43:37'),(10,2,10,1,'2026-03-15 11:43:37'),(16,2,16,1,'2026-03-15 11:45:33'),(17,2,17,1,'2026-03-15 11:45:33'),(18,2,18,1,'2026-03-15 11:45:33'),(19,2,19,1,'2026-03-15 11:45:33'),(20,2,20,1,'2026-03-15 11:45:33'),(24,2,62,1,'2026-03-15 18:12:13'),(25,3,63,1,'2026-03-15 18:23:48'),(27,3,36,1,'2026-03-15 18:27:10'),(28,2,36,1,'2026-03-16 08:08:58'),(29,4,36,1,'2026-03-16 08:08:58');
