-- ================================================================
-- dump.sql — MarsAI Festival 2026 — Snapshot complet de la BDD
-- ================================================================
-- Généré le : 2026-03-14
--
-- Usage (développeurs) :
--   1. Démarrez votre serveur MySQL
--   2. Importez ce fichier :
--        mysql -u root -p < dump.sql
--      Ou via MAMP/WAMP :
--        /Applications/MAMP/Library/bin/mysql80/bin/mysql \
--          --socket=/Applications/MAMP/tmp/mysql/mysql.sock \
--          -u root -proot < dump.sql
--
-- Ce dump contient :
--   - Toutes les tables du schéma MarsAI
--   - 1 compte admin     : admin@gmail.com  / azerty
--   - 5 comptes jurés    : stephane.job@laplateforme.io ... / azerty
--   - 60 réalisateurs    : données de test variées (30 pays)
--   - 60 films           : statuts mixtes, vidéos S3 attachées
--
-- ⚠️  Les vidéos S3 (video_url) pointent vers le bucket Scaleway.
--     Si besoin de ré-uploader les vidéos :
--        node backend/scripts/seed-s3.js /chemin/vers/video.mp4
-- ================================================================
...
-- Dump completed on 2026-03-14 19:38:06
