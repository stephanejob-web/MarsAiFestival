...
('Justine Triet', 'Réalisatrice', 'Présidente du Jury', 'Palme d''Or 2023 pour Anatomie d''une chute. Elle préside le jury marsAI 2026 avec l''ambition d''élever la création IA au rang d''art majeur.', 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&h=400&fit=crop&crop=face', 1, 0, 1),
('David Fincher', 'Réalisateur & Producteur', 'Membre du Jury', NULL, 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop&crop=face', 0, 1, 1),
('Cédric Jimenez', 'Réalisateur & Scénariste', 'Membre du Jury', NULL, 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400&h=400&fit=crop&crop=face', 0, 2, 1),
('Valérie Donzelli', 'Réalisatrice & Actrice', 'Membre du Jury', 'La création sans frontières est la promesse de l''IA — c''est ce que nous voulons voir dans les films de cette édition.', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&h=400&fit=crop&crop=face', 0, 3, 1),
('Yann LeCun', 'Directeur Scientifique Meta AI', 'Expert IA', 'L''intelligence artificielle n''est pas une menace pour le cinéma — c''est son prochain chapitre.', 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&h=400&fit=crop&crop=face', 1, 4, 1),
('Maïmouna Doucouré', 'Réalisatrice', 'Membre du Jury', 'Montrer des histoires vraies avec des outils nouveaux — c''est le défi de notre génération de cinéastes.', 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=400&h=400&fit=crop&crop=face', 0, 5, 1),
('Luc Julia', 'Co-inventeur de Siri, DG Renault', 'Expert IA', 'L''IA n''existe pas seule — elle n''existe qu''au service de l''humain et de sa créativité.', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=400&fit=crop&crop=face', 0, 6, 1),
('Alice Diop', 'Réalisatrice & Documentariste', 'Membre du Jury', 'Le court-métrage IA ouvre des possibilités narratives inédites — j''ai hâte de les explorer avec vous.', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&h=400&fit=crop&crop=face', 0, 7, 1);
