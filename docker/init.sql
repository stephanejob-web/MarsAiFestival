-- marsAI Festival — init.sql (generated from local MAMP dump 2026-03-21)

CREATE DATABASE IF NOT EXISTS marsai CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE marsai;
...
INSERT INTO `award` (`id`, `name`, `description`, `cash_prize`, `laureat`, `created_at`, `updated_at`, `display_rank`, `reveal_at`) VALUES (1,'Grand Prix marsAI','Récompense le film le plus abouti artistiquement et techniquement.','5 000 €',NULL,'2026-03-21 13:19:52','2026-03-21 13:19:52',1,NULL),(2,'Prix du Jury','Coup de cœur des membres du jury international.','2 000 €',NULL,'2026-03-21 13:19:52','2026-03-21 13:19:52',2,NULL),(3,'Prix de l\'Innovation IA','Film ayant fait l\'usage le plus créatif de l\'intelligence artificielle.','1 500 €',NULL,'2026-03-21 13:19:52','2026-03-21 13:19:52',3,NULL),(4,'Prix du Mobile','Meilleur film tourné et monté intégralement sur smartphone.','1 000 €',NULL,'2026-03-21 13:19:52','2026-03-21 13:19:52',4,NULL),(5,'Mention Spéciale','Distinction honorifique décernée par le jury.',NULL,NULL,'2026-03-21 13:19:52','2026-03-21 13:19:52',5,NULL);
...
INSERT INTO `cms_content` (`id`, `header_logo`, `hero_video_path`, `hero_label`, `hero_title`, `hero_description`, `hero_content`, `jury_section_label`, `jury_section_title`, `jury_section_description`, `jury_section_content`, `phase_top50_open_date`, `phase_top50_close_date`, `phase_award_open_date`, `phase_award_close_date`, `header_logo_toggle`, `hero_video_toggle`, `is_jury_list_toggle`, `created_at`, `updated_at`, `submission_open_date`, `submission_close_date`, `ceremony_date`, `hero_tag1`, `hero_tag2`, `hero_tag3`, `hero_tag4`, `contact_email`, `contact_instagram`, `contact_website`, `contact_description`, `finalist_count`) VALUES (1,NULL,'/uploads/hero/hero_1774097497036.mp4','marsAI 2027','Le premier festival mondial du cinéma généré par intelligence artificielle.','Voici ce qu\'une IA peut créer. Imaginez ce que vous allez faire.','Soumettre un film',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,1,0,'2026-03-21 12:36:46','2026-03-21 12:55:05',NULL,NULL,NULL,'60s chrono','120+ pays','100% gratuit','Prix Marseille','contact@marsai.fr','@marsai.festival','https://marsai.fr','Marseille accueille la première édition de marsAI, festival international dédié aux films créés par ou avec l\'intelligence artificielle.',5);
...
INSERT INTO `film_discussion` (`id`, `film_id`, `added_by`, `added_at`) VALUES (5,2,2,'2026-03-16 15:05:27'),(6,4,2,'2026-03-16 15:06:39'),(8,69,5,'2026-03-19 13:14:42'),(9,70,4,'2026-03-19 13:46:25');
...
INSERT INTO `jury_film_comment` (`id`, `jury_id`, `film_id`, `text`, `created_at`) VALUES (1,2,70,'sss','2026-03-19 15:14:04'),(2,2,70,'sqsqs','2026-03-19 15:14:09'),(3,2,70,'sqsqsqs','2026-03-19 15:14:14');
...
INSERT INTO `programme_event` (`id`, `day`, `time`, `title`, `description`, `type`, `sort_order`) VALUES (1,1,'09:00','Accueil & accréditations','Ouverture des portes — Friches Belle de Mai, Marseille.','default',0),(2,1,'10:00','Ouverture officielle','Mot de la présidente du jury et présentation de l edition 2026.','opening',1),(3,1,'10:45','Masterclass — Créer avec Sora & Runway','Techniques, prompts et workflow pour le court-métrage IA.','masterclass',2),(4,1,'12:30','Pause déjeuner',NULL,'pause',3),(5,1,'14:00','Projections — Sélection officielle (Bloc 1/4)','5 films en compétition. Séance suivie d une discussion avec les créateurs.','projection',4),(6,1,'15:45','Table ronde — IA et cinéma','Avec des réalisateurs, producteurs et artistes numériques.','masterclass',5),(7,1,'17:00','Projections — Sélection officielle (Bloc 2/4)','5 films en compétition.','projection',6),(8,1,'18:30','Apéritif créateurs','Networking & rencontres entre participants.','default',7),(9,1,'20:00','Soirée ouverture — DJ set génératif','Musique générée en temps réel par IA. Entrée libre.','gala',8),(10,2,'09:30','Projections — Sélection officielle (Bloc 3/4)','5 films en compétition.','projection',0),(11,2,'11:00','Atelier live — Prompt to Screen en 60 minutes','Créez un court-métrage IA en direct avec les outils du festival.','masterclass',1),(12,2,'12:30','Pause déjeuner',NULL,'pause',2),(13,2,'14:00','Projections — Sélection officielle (Bloc 4/4)','5 films en compétition. Dernière séance avant délibération.','projection',3),(14,2,'15:30','Délibération du jury','Séance à huis clos — vote du public ouvert en ligne.','default',4),(15,2,'17:30','Clôture du vote public',NULL,'opening',5),(16,2,'19:00','Cérémonie des prix','Remise des prix — Friches Belle de Mai.','gala',6),(17,2,'20:30','Soirée de clôture — Performance IA live','Clôture artistique et cocktail final.','gala',7);
...
INSERT INTO `sponsor` (`id`, `name`, `partnership_statut`, `sponsored_award`, `sponsor_link`, `sponsor_logo`, `created_at`, `updated_at`) VALUES (1,'La Plateforme_','main','Grand Prix marsAI','https://www.la-plateforme.fr','https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/La_Plateforme_logo.svg/600px-La_Plateforme_logo.svg.png','2026-03-21 12:57:39','2026-03-21 12:57:39'),(2,'Mobile Film Festival','lead','Prix du Mobile','https://mobilefilmfestival.com','https://mobilefilmfestival.com/wp-content/uploads/2023/09/mff-logo-white.png','2026-03-21 12:57:39','2026-03-21 12:57:39'),(3,'Mistral AI','lead','Prix de l\'Innovation IA','https://mistral.ai','https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Mistral_AI_logo.svg/600px-Mistral_AI_logo.svg.png','2026-03-21 12:57:39','2026-03-21 12:57:39'),(4,'Ville de Marseille','premium',NULL,'https://www.marseille.fr','https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Blason_ville_fr_Marseille_%2813%29.svg/200px-Blason_ville_fr_Marseille_%2813%29.svg.png','2026-03-21 12:57:39','2026-03-21 12:57:39'),(5,'ARTE','premium','Prix du Documentaire','https://www.arte.tv','https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Arte_Logo_2019.svg/400px-Arte_Logo_2019.svg.png','2026-03-21 12:57:39','2026-03-21 12:57:39'),(6,'CNC – Centre National du Cinéma','partner',NULL,'https://www.cnc.fr','https://www.cnc.fr/documents/36995/0/logo-cnc.png','2026-03-21 12:57:39','2026-03-21 12:57:39'),(7,'Aix-Marseille Université','partner','Prix Académique','https://www.univ-amu.fr','https://upload.wikimedia.org/wikipedia/commons/thumb/9/9c/Aix-Marseille_University_logo.svg/400px-Aix-Marseille_University_logo.svg.png','2026-03-21 12:57:39','2026-03-21 12:57:39'),(8,'France Télévisions','partner',NULL,'https://www.france.tv','https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/France_televisions_logo.svg/400px-France_televisions_logo.svg.png','2026-03-21 12:57:39','2026-03-21 12:57:39'),(9,'Région Sud','supporter',NULL,'https://www.maregionsud.fr','https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Logo_région_Sud_Provence-Alpes-Côte_d%27Azur.svg/300px-Logo_région_Sud_Provence-Alpes-Côte_d%27Azur.svg.png','2026-03-21 12:57:39','2026-03-21 12:57:39'),(10,'Dailymotion','supporter',NULL,'https://www.dailymotion.com','https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Dailymotion_logo_%282017%29.svg/400px-Dailymotion_logo_%282017%29.svg.png','2026-03-21 12:57:39','2026-03-21 12:57:39'),(11,'Canson','supporter',NULL,'https://www.canson.com',NULL,'2026-03-21 12:57:39','2026-03-21 12:57:39');
